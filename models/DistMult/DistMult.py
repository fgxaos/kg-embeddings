...
### CLASS DEFINITION ###
class DistMult(pl.LightningModule):
    """DistMult model.

    Model introduced in "Embedding Entities and Relations for Learning and Inference in Knowledge Bases".
